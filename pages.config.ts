  ...
  subPackages: [
    ...
    },
    {
      ...
      pages: [
        ...
        { path: 'cquanyiCard/AppointmentConsult', type: 'page' },
        { path: 'cquanyiCard/message', type: 'page' },
        { path: 'cquanyiCard/HealthcareFavorites', type: 'page' },
        { path: 'cquanyiCard/favoriteProducts', type: 'page' },
      ],
    },
  ],
