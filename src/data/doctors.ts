import type { ClinicDoctor, Doctor } from '@/types2'
import { Department, DoctorStatus } from '@/types2'
...
// 导出在线坐诊医生的辅助函数
export function getClinicDoctorById(id: number): ClinicDoctor | undefined {
