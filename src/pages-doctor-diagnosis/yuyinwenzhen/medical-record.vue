...
<template>
  <view class="relative mx-auto max-w-[375px] min-h-screen w-full bg-[#F3F1ED] pb-[60px] overflow-x-hidden">
    <!-- 顶部导航 -->
    ...
    <!-- 主要内容区 -->
    <main class="px-4 pt-[64px] space-y-5">
      <!-- 基本信息 -->
      <section class="w-full rounded-[20px] bg-white p-4 sm:p-5 shadow-[0px_2px_8px_0px_rgba(0,0,0,0.06)] overflow-hidden">
        ...
        <div class="mb-5 flex flex-col items-center">
          ...
          <div class="text-sm text-[#6B7280] overflow-hidden">
            患者编号：GH973212
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <!-- 初诊日期 -->
          <div class="sm:col-span-2 rounded-xl bg-[#F9FAFB] p-3 text-center">
            <div class="mb-1 flex items-center justify-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#8E4337" class="h-4 w-4">
        ...
        <div class="space-y-3">
          ...
          <div class="rounded-xl bg-[#F5EBE9] p-3">
            <div class="mb-2 flex items-center justify-between">
              ...
              <span class="text-base text-[#8E4337] font-bold truncate">2型糖尿病</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-sm text-[#6B7280]">中医诊断</span>
              <span class="text-base text-[#8E4337] font-bold truncate">消渴病</span>
            </div>
          </div>
        ...
        <div class="max-h-0 overflow-hidden transition-all duration-300 ease" :style="{ maxHeight: expandedSections.medicalHistory ? '2000px' : '0px' }">
          <div class="space-y-3">
            ...
            <div>
              ...
              <div class="text-sm text-[#6B7280] leading-relaxed overflow-hidden">
                发现血糖升高1年，伴口干、乏力半年。
              </div>
            </div>
            ...
            <div>
              ...
              <div class="text-sm text-[#6B7280] leading-relaxed overflow-hidden">
                患者1年前体检发现空腹血糖升高至8.2mmol/L，未予重视。半年前出现口干、多饮、乏力症状，就诊于当地医院，诊断为"2型糖尿病"，予二甲双胍治疗，效果欠佳。近期症状加重，遂来我处就诊。
              </div>
            </div>
      ...
      <section class="w-full rounded-[20px] bg-white p-4 sm:p-5 shadow-[0px_2px_8px_0px_rgba(0,0,0,0.06)] overflow-hidden">
        ...
        <div class="space-y-4">
          ...
          <div class="relative pl-6 before:absolute before:bottom-[-20px] before:left-7 before:top-[40px] before:w-0.5 before:bg-[#E5E7EB] before:content-['']">
            ...
            <div class="cursor-pointer rounded-xl bg-[#F9FAFB] p-3 sm:p-4 transition-colors hover:bg-[#F3F4F6] overflow-hidden" @click="toggleRecord('record003')">
              <div class="mb-2 flex items-center justify-between">
                <span class="text-base text-[#1F2937] font-bold truncate">问诊记录 003</span>
                <div class="flex items-center gap-2">
                  <span class="rounded-full bg-[#D1FAE5] px-2 py-0.5 text-xs text-[#10B981] font-semibold whitespace-nowrap">图文问诊</span>
                  <svg
            ...
            <div class="max-h-0 overflow-hidden transition-all duration-300 ease" :style="{ maxHeight: expandedSections.record003 ? '2000px' : '0px' }">
              <div class="mt-3 border border-[#E5E7EB] rounded-xl bg-white p-3 sm:p-4 space-y-3 overflow-hidden">
                <!-- 四诊信息 -->
                <div>
                  ...
                  <div class="text-sm space-y-2">
                    <div class="overflow-hidden"><span class="text-[#6B7280]">问诊：</span><span class="text-[#1F2937]">服药前餐前血糖12.6mmol/L，现降至4.5mmol/L。口干明显减轻，体力较前好转，夜尿1次。睡眠可，大便调。</span></div>
          ...
          <div class="relative pl-6 before:absolute before:bottom-[-20px] before:left-7 before:top-[40px] before:w-0.5 before:bg-[#E5E7EB] before:content-['']">
            ...
            <div class="cursor-pointer rounded-xl bg-[#F9FAFB] p-3 sm:p-4 transition-colors hover:bg-[#F3F4F6] overflow-hidden" @click="toggleRecord('record002')">
              <div class="mb-2 flex items-center justify-between">
                <span class="text-base text-[#1F2937] font-bold truncate">问诊记录 002</span>
                <div class="flex items-center gap-2">
                  <span class="rounded-full bg-[#E0E7FF] px-2 py-0.5 text-xs text-[#6366F1] font-semibold whitespace-nowrap">视频问诊</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#6B7280"
                    class="h-4 w-4 transition-transform"
          ...
          <div class="relative pl-6">
            ...
            <div class="cursor-pointer rounded-xl bg-[#F9FAFB] p-3 sm:p-4 transition-colors hover:bg-[#F3F4F6] overflow-hidden" @click="toggleRecord('record001')">
              <div class="mb-2 flex items-center justify-between">
                <span class="text-base text-[#1F2937] font-bold truncate">问诊记录 001</span>
                <div class="flex items-center gap-2">
      ...
      <section class="w-full rounded-[20px] bg-white p-4 sm:p-5 shadow-[0px_2px_8px_0px_rgba(0,0,0,0.06)] overflow-hidden">
        ...
        <div class="space-y-3">
          <!-- 当前处方 -->
          <div class="border-2 border-[#8E4337] rounded-xl bg-[#F5EBE9] p-3 sm:p-4 overflow-hidden">
            <div class="mb-2 flex items-center justify-between">
              <div class="flex items-center gap-2">
                <span class="text-base text-[#1F2937] font-bold">当前处方</span>
                <span class="rounded-full bg-[#10B981] px-1.5 py-0.5 text-xs text-white font-semibold whitespace-nowrap">使用中</span>
              </div>
              <span class="text-xs text-[#6B7280]">2025-06-10</span>
            </div>
            <div class="mb-2 text-sm text-[#8E4337] font-medium truncate">
              自拟方加减
            </div>
            <div class="mb-3 text-xs text-[#6B7280] truncate">
              益气养阴、清热生津
            </div>
            <button
          ...
          <div class="space-y-2">
            ...
            <div class="cursor-pointer rounded-lg bg-[#F9FAFB] p-3 transition-colors hover:bg-[#F3F4F6]" @click="viewPrescription('002')">
              <div class="flex items-center justify-between">
                <div class="flex-1">
                  <div class="mb-1 text-sm text-[#1F2937] font-medium truncate">
                    自拟方（调整版）
                  </div>
                  <div class="text-xs text-[#6B7280]">
                    2025-03-15
