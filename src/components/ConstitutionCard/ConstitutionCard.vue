...
import type { ConstitutionCardProps, ConstitutionCardEmits } from './types'
...
<template>
  <div 
    class="relative z-0 h-[280rpx] w-[334rpx] flex flex-col items-start cursor-pointer"
  ...
  >
    <div class="relative ml-0 mt-0 h-[280rpx] w-[334rpx] flex flex-col items-start rounded-[16rpx] from-[#fff1f2] to-[#fce3e1] bg-gradient-to-br">
      <!-- 体质状态区域 -->
      <div 
        class="relative ml-[16rpx] mt-[16rpx] h-[40rpx] w-[288rpx] flex flex-row items-start cursor-pointer"
        @click.stop="handleConstitutionClick"
      >
        <span class="relative ml-0 mt-[8rpx] whitespace-pre text-[24rpx] text-[#ba7210] font-bold leading-[100%]">
          体质状态：
        </span>
      ...
      <div class="relative ml-[16rpx] mt-[16rpx] h-[192rpx] w-[302rpx] flex flex-col items-start">
        <div 
          class="relative ml-0 mt-0 h-[192rpx] w-[302rpx] flex flex-col items-start rounded-[8rpx] bg-white/50 cursor-pointer"
          @click.stop="handleAdviceClick"
        >
          <span class="relative ml-[18rpx] mt-[10rpx] whitespace-pre text-[24rpx] text-[#333333] font-medium leading-[100%]">
            {{ adviceTitle }}
          </span>
          <span class="relative ml-[16rpx] mt-[22rpx] w-[270rpx] text-justify text-[24rpx] text-[#ababab] font-medium leading-[40rpx]">
            {{ adviceContent }}
          </span>
        </div>
      </div>
