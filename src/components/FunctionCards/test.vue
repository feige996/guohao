<template>
  <div class="p-4 space-y-4">
    <h2 class="text-xl font-bold">背景图片测试</h2>
    
    <!-- 测试原始路径 -->
    <div class="space-y-2">
      <h3 class="text-lg font-semibold">原始路径测试</h3>
      <div 
        class="h-[156rpx] w-[328rpx] bg-cover bg-center bg-no-repeat border border-gray-300"
    ...
    <!-- 测试别名路径 -->
    <div class="space-y-2">
      <h3 class="text-lg font-semibold">别名路径测试</h3>
      <div 
        class="h-[156rpx] w-[328rpx] bg-cover bg-center bg-no-repeat border border-gray-300"
    ...
    <!-- 测试动态路径 -->
    <div class="space-y-2">
      <h3 class="text-lg font-semibold">动态路径测试</h3>
      <div 
        class="h-[156rpx] w-[328rpx] bg-cover bg-center bg-no-repeat border border-gray-300"
    ...
    <!-- 测试组件 -->
    <div class="space-y-2">
      <h3 class="text-lg font-semibold">FunctionCards 组件测试</h3>
    ...
    <!-- 测试 img 标签 -->
    <div class="space-y-2">
      <h3 class="text-lg font-semibold">img 标签测试</h3>
      <img 
        src="@img/homepage/appointment-icon.png" 
        alt="测试图片" 
        class="h-[156rpx] w-[328rpx] object-cover border border-gray-300"
      >
    </div>
  </div>
</template>
...
import FunctionCards, { type FunctionCardItem } from './index'
